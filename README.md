...
| [Research field assignment model](https://github.com/data-S-index/s-index-real-world)| Code | Code for the custom fine-tuned model we developed to assign research fields to datasets based on their metadata using the OpenAlex Topics taxonomy | Stable | v1.0.0 | MIT | 
