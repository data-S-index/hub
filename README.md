...
| [Scholar Data app](https://github.com/data-S-index/web-app)| Code | Code of the Scholar Data web app | Stable | v1.0.0 | MIT | 
| [Scholar Data dev](https://github.com/data-S-index/dev-pipeline)| Code | Development pipeline for the Scholar Data app | Stable | v1.0.0 | MIT | 
| [S-index API](https://github.com/data-S-index/s-index-api)| Code | API linking to our Dataset Registry | Stable | v1.0.0 | MIT |
